  ...
  const notifications = [
    {
      ...
      message:
        "Complaint CF-1008 has been assigned to you by the administrator.",
      time: "10 minutes ago",
      type: "assigned",
      unread: true,
    },
    {
      ...
      message:
        "Complaint CF-1005 has been reopened by the student and requires your attention.",
      time: "1 hour ago",
      type: "reopened",
      unread: true,
    },
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Updates related to your assigned complaints
          </p>
        </div>
